...
**Precursors & rumor (Phase 3+; see §7 risk 7)** — The knowledge model (§2.2) gives *staleness*. This gives *anticipation* — and it is the difference between "how old is my info" and "did I read what I already had?"
...
8. **Solo burnout** — mitigated by the phase gates: every 2–3 months produces something playable or a clear kill signal. The feel spike (Phase −1) also front-loads a morale win.
